	...
	public void actionPerformed(ActionEvent e) {
		...
		if (mF.deleteStudentRadioButton.isSelected()) {
			...
			if (newStudent != null) {
				...
				int result = JOptionPane.showConfirmDialog(null, modPanel, "Provide the new data:",
				...
				JOptionPane.showMessageDialog(null, "No student with given matriculation nr: " + modID,
			...
			if (newProf != null) {
				...
				JOptionPane.showMessageDialog(null, "No professor with given course: " + modID,
						"Information", JOptionPane.INFORMATION_MESSAGE);
			}
		} else {
			...
			if (newModule != null) {
				...
				JTextField partField = new JTextField(Math.max(newModule.getParticipants().length(), 10));
				...
				int result = JOptionPane.showConfirmDialog(null, modPanel, "Provide new data:",
						JOptionPane.OK_CANCEL_OPTION);
				if (result == JOptionPane.OK_OPTION) {
				...
				JOptionPane.showMessageDialog(null, "No module with given module nr: " + modID,
						"Information", JOptionPane.INFORMATION_MESSAGE);
			}
		}
	}
