...
import campus_manager.main.Manager;
...
public class Module extends TableItem {
	...
	public void addParticipants(String list) {
		...
		part = data[4];
		if (nonStud != null)
			JOptionPane.showMessageDialog(null, "Students with Matriculation Nrs: " + nonStud
					+ " do not exist.\nThey are removed from the module.", "Information",
